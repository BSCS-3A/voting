            ...
            if($heir_id != $cand){
                ...
                // insert candidate divs here
                    ...
                    echo '
                        <div>
                            <label class="checkbox">
                                <input type="radio" name="'.$poss["heirarchy_id"].'"  id="vote" value = "Abstain">
                                    <span class="checkmark"></span><br><br><b> Abstain </b>
                            </label>
                        </div>
                    </div>'; // display abstain choice
                    echo '<div class="candidate-box" >
                        ...
                        // display candidate
                        echo '<a href="#" id="F-CandidateName"><b> Candidate name:' . $poss["fname"]. " " . $poss["lname"]  . '</b></a><br><a href="#" id="F-Partylist"> Party: ' . $poss["party_name"]. '</a><br>
                        <a href="#" id="F-Platform"> Platform: ' . $poss["platform_info"]. '</a>';
